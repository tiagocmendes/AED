    ...
    case 1:
      ...
      { 
        ...
        for(i = 0;i < n;i++)
        {
          ...
          b[i] = (double)rand() / (double)RAND_MAX; // an uniformly distributed pseudo-random number
        }
        ...
        // vector_inner_product(n,a,b)
        counter = 0l;
        (void)vector_inner_product(n,a,b);
        printf(" %20ld",counter);

        // vector_addition(n,a,b,r)
        counter = 0l;
    ...
    case 2:
      ...
      for(n = 1;n <= 20;n++)
      {
        ...
        for(i = 0;i < n;i++)
        {
          ...
          b[i] = (double)rand() / (double)RAND_MAX; // esta bem, mas da diferente para toda a gente
        }
        ...
        // matrix_sum(n,a[n])
        counter = 0l;
        (void)matrix_sum(n,A); // ignore the return value!
        printf(" %10ld",counter);

        // matrix_vector_product(n,a[n][n],b[n],r[n])
        counter = 0l;
        (void)matrix_vector_product(n,A,b,r); // ignore the return value!
        printf(" %21ld",counter);

        // matrix_addition(n,A[n][n],B[n][n],R[n][n])
        counter = 0l;
        (void)matrix_addition(n,A,B,R); // ignore the return value!
        printf(" %15ld",counter);

        // insertion_sort(n,a[n])
        counter = 0l;
